    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: {
          type: 'string',
          description:
            'Antigravity model for this request, e.g. "Gemini 3.6 Flash (High)". Run `agy models` for the live inventory — no list is hardcoded here. Omit to use agy\'s own default, which is kept at the newest available version.',
        },
        sessionId: {
          type: 'string',
          description:
